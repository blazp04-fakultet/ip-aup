    ...
    <div class="max-w-7xl mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-2">
          <div class="flex items-center mb-4">
            ...
            <span class="text-xl font-bold text-white">LLMBridge</span>
          </div>
          <p class="text-slate-400 mb-4 max-w-md">
            Jedini AI API koji ti treba. Pristupaj svim vodećim AI modelima preko jednog jednostavnog API-ja.
          </p>
        ...
        <!-- Quick Links -->
        <div>
          <h4 class="text-white font-semibold mb-4">Proizvod</h4>
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-slate-400 hover:text-white transition-colors">Dokumentacija</a></li>
        ...
        <!-- Support -->
        <div>
          <h4 class="text-white font-semibold mb-4">Podrška</h4>
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-slate-400 hover:text-white transition-colors">Kontakt</a></li>
      ...
      <div class="border-t border-slate-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
        <p class="text-slate-400 text-sm">
          © 2025 LLMBridge. Sva prava zadržana.
        </p>
        <div class="flex space-x-6 mt-4 md:mt-0">
          <a href="#" class="text-slate-400 hover:text-white transition-colors text-sm">Privacy Policy</a>
          <a href="#" class="text-slate-400 hover:text-white transition-colors text-sm">Terms of Service</a>
        </div>
      </div>
    </div>
  </footer>
